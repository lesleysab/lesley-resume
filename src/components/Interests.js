    ...
    return (
      <React.Fragment>
        <div className="interests">
          ...
          <hr />
          <p>
            <strong>DOGS & VOLUNTEERING.</strong> I have 2 rescue pups and have
            fostered countless dogs over the years. I'm on the board of
            BARKITECTURE ATX as a web developer. It's a custom doghouse design
            show and contest by local builder, architect and design teams. Check
            out the{" "}
          ...
          <p>
            ...
            I have lots of degrees and certifications. I love to learn and is a
            primary reason why I love working for software companies. I am
            always reading, practicing, researching in order to be proficient
            with the latest and greatest.
          </p>
          <p>
            <strong>THE GREAT OUTDOORS.</strong>
            Nature is the best medicine. From hiking to running to cartwheeling
            down a trail, I find it to be the best place to be on earth.{" "}
            <a
